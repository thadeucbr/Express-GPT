...
### 1. Email inválido
```curl -X POST -H "Content-Type: application/json" -d '{"nome":"Thadeu Teste","email":"joao.emailinvalido","senha":"senha123"}' http://localhost:3000/user```
...
```curl -X POST -H "Content-Type: application/json" -d '{"nome":"Thadeu Teste","email":"joao@email.com","senha":"123"}' http://localhost:3000/user```
...
```curl -X POST -H "Content-Type: application/json" -d '{"nome":"Thadeu Teste","email":"joao@email.com","senha":"senha123"}' http://localhost:3000/user```
